// DlgTreeEdit.cpp : implementation of the CDlgTreeEdit class
//
...
CDlgTreeEdit::CDlgTreeEdit(CWnd *pParent)
	: CDialog(CDlgTreeEdit::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlgTreeEdit)
	//}}AFX_DATA_INIT
}


void CDlgTreeEdit::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgTreeEdit)
	DDX_Control(pDX, IDC_REPORT_CONTROL, m_wndReport);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CDlgTreeEdit, CDialog)
	//{{AFX_MSG_MAP(CDlgTreeEdit)
	//}}AFX_MSG_MAP
	ON_NOTIFY(NM_RCLICK, IDC_REPORT_CONTROL, OnReportRClick)
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDlgTreeEdit message handlers
...
BOOL CDlgTreeEdit::OnInitDialog()
{
	...
	m_wndReport.LockExpand(FALSE);		// Row not expandable / collapsible
#endif
...
void CDlgTreeEdit::OnOK()
{
	CDialog::OnOK();
}

void CDlgTreeEdit::OnReportRClick(NMHDR * pNotifyStruct, LRESULT * /*result*/)
{
