...
#if !defined(AFX_DLGPROPERTYGRID_H__INCLUDED_)
#define AFX_DLGPROPERTYGRID_H__INCLUDED_
...
class CDlgPropertyGrid : public CXTPResizeDialog
{
// Construction
public:
	CDlgPropertyGrid(CWnd* pParent = NULL); // standard constructor

// Dialog Data
	//{{AFX_DATA(CDlgPropertyGrid)
	enum { IDD = IDD_DLG_PROPERTYGRID };
...
protected:
	...
	CXTPResizeGroupBox m_groupAppearance;
	CXTPResizeGroupBox m_groupSort;
	CXTPResizeGroupBox m_groupColor;
...
protected:
	...
	afx_msg void OnClickedChkMarkup();
...
#endif // !defined(AFX_DLGPROPERTYGRID_H__INCLUDED_)
