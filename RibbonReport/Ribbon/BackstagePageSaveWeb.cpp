...
void CBackstagePageSaveWeb::DoDataExchange(CDataExchange* pDX)
{
	...
	//}}AFX_DATA_MAP
	DDX_Control(pDX, IDC_SAVE_WEB_SC_SEPARATOR, m_lblSeparator);
	DDX_Control(pDX, IDC_SAVE_WEB_TXT_CAPTION, m_lblCaption);
	DDX_Control(pDX, IDC_SAVE_WEB_BN_SIGNIN, m_btnSignIn);
}
...
BOOL CBackstagePageSaveWeb::OnInitDialog() 
{
	...
	SetResize(IDC_SAVE_WEB_SC_SEPARATOR, XTP_ANCHOR_TOPLEFT, XTP_ANCHOR_TOPRIGHT);	
