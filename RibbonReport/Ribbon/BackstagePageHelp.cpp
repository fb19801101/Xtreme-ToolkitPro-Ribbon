...
CBackstagePageHelp::CBackstagePageHelp() : CXTPRibbonBackstagePage(CBackstagePageHelp::IDD)
{
	...
	UINT nIDs[] = {IDC_HELP_BN_HELP, IDC_HELP_BN_GETTING_STARTED, IDC_HELP_BN_CONTACT_US, IDC_HELP_BN_OPTIONS, IDC_HELP_CK_UPDATES};
...
void CBackstagePageHelp::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_HELP_SC_SEPARATOR_1, m_lblSeparator1);
	DDX_Control(pDX, IDC_HELP_SC_SEPARATOR_2, m_lblSeparator2);
	DDX_Control(pDX, IDC_HELP_SC_SEPARATOR_3, m_lblSeparator3);
	DDX_Control(pDX, IDC_HELP_SC_SEPARATOR_4, m_lblSeparator4);

	DDX_Control(pDX, IDC_HELP_BN_HELP, m_btnHelp);
	DDX_Control(pDX, IDC_HELP_BN_GETTING_STARTED, m_btnGettingStarted);
	DDX_Control(pDX, IDC_HELP_BN_CONTACT_US, m_btnContactUs);
	DDX_Control(pDX, IDC_HELP_BN_OPTIONS, m_btnOptions);
	DDX_Control(pDX, IDC_HELP_CK_UPDATES, m_btnCheckForUpdates);

	DDX_Control(pDX, IDC_HELP_TXT_CAPTION, m_lblSupport);
	DDX_Control(pDX, IDC_HELP_TXT_TOOLS, m_lblTools);
	DDX_Control(pDX, IDC_HELP_TXT_ABOUT, m_lblAbout);
}
...
BOOL CBackstagePageHelp::OnInitDialog() 
{
	...
	SetDlgItemText(IDC_HELP_TXT_TEXT, strVersion);

	SetResize(IDC_HELP_SC_SEPARATOR_4, XTP_ANCHOR_TOPLEFT, XTP_ANCHOR_BOTTOMLEFT);
