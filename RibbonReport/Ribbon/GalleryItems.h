...
class CGalleryItemVariant : public CXTPControlGalleryItem
{
public:
	CGalleryItemVariant(int nId, CXTPImageManagerIcon* pImage = NULL);
	CGalleryItemVariant(LPCTSTR lpszCaption, CXTPImageManagerIcon* pImage = NULL);
	CGalleryItemVariant(COleVariant vCaption, CXTPImageManagerIcon* pImage = NULL);
	CGalleryItemVariant(int nId, LPCTSTR lpszCaption, CXTPImageManagerIcon* pImage = NULL);
	CGalleryItemVariant(int nId, COleVariant vCaption, CXTPImageManagerIcon* pImage = NULL);
	CGalleryItemVariant(CGalleryItemVariant& src);
	virtual ~CGalleryItemVariant();

	CGalleryItemVariant& operator= (CGalleryItemVariant& src);
	CGalleryItemVariant& operator= (int nId);
	CGalleryItemVariant& operator= (LPCTSTR lpszCaption);
	CGalleryItemVariant& operator= (COleVariant vCaption);
	CGalleryItemVariant& operator= (CXTPImageManagerIcon* pImage);
