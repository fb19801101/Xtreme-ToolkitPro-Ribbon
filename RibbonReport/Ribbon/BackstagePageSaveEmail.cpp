...
void CBackstagePageSaveEmail::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_SAVE_EMAIL_SC_SEPARATOR, m_lblSeparator);
	DDX_Control(pDX, IDC_SAVE_EMAIL_TXT_CAPTION, m_lblCaption);
	DDX_Control(pDX, IDC_SAVE_EMAIL_BN_SEND, m_btnSend);
...
BOOL CBackstagePageSaveEmail::OnInitDialog() 
{
	...
	SetResize(IDC_SAVE_EMAIL_SC_SEPARATOR, XTP_ANCHOR_TOPLEFT, XTP_ANCHOR_TOPRIGHT);	
